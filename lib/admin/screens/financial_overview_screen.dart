...
class _FinancialOverviewScreenState extends State<FinancialOverviewScreen> {
  ...
  Future<void> _loadFinancialData() async {
    try {
      // Fetch inventory items to calculate total value
      ...
      setState(() {
        financialRecords = List<Map<String, dynamic>>.from(financialResponse);
        ...
        totalRevenue = inventoryTotalValue + financialRecordsRevenue;

        // Recalculate Net Profit after fetching new revenue
        _calculateTotals();
      });
    } catch (e) {
